...
public class StokOperasyonFacadeTest {
    @Test
    void stokCikisiSonrasiMiktarAzalir() {
        ...
        int oncekiStok = parti.getKalanMiktar();
        int cikisMiktari = 2;

        StokOperasyonFacade facade = new StokOperasyonFacade();
        facade.stokCikisOperasyonu(parti.getPartiId(), cikisMiktari, personelId, subeId, parti.getDepoId());

        Parti guncel = partiDAO.getById(parti.getPartiId());
        assertEquals(oncekiStok - cikisMiktari, guncel.getKalanMiktar());
    }
